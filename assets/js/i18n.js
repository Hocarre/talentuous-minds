...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "legal.privacy.collect.text": "The contact and application forms work exclusively through your email client: the information you enter is sent directly by email and does not pass through this site.",
      "legal.privacy.collect.text2": "The quote request form (Simulation services page) stores the information submitted in a spreadsheet hosted by Google LLC (Google Sheets), via the Google Apps Script service. The data recorded is: name, email address, organisation, status, requested services, project description and available data.",
      "legal.privacy.subprocessors": "Sub-processors",
      "legal.privacy.subprocessors.text": "Data submitted via the quote request form is processed by the following sub-processors:",
      "legal.privacy.subprocessors.note": "These providers may transfer data outside the European Union. They contractually undertake to apply appropriate safeguards (standard contractual clauses).",
      ...
      "services.sim.btn3": "See the service details",
      "services.sim.5.title": "ADMET filtering",
      "services.sim.5.text": "Assessment of absorption, distribution, metabolism, excretion and toxicity properties. Lipinski's rules, bioavailability prediction and elimination of problematic compounds before laboratory testing.",
      "services.sim.6.title": "LaTeX scientific writing",
      "services.sim.6.text": "Formatting of your articles, theses and reports with LaTeX: IMRaD structuring, booktabs tables, multi-panel figures, BibTeX bibliography and compliance with journal requirements.",

      /* --- Page Prestations de simulation --- */
      "sim.hero.eyebrow": "Computational services",
      "sim.hero.title": "We run your simulations for you",
      "sim.hero.lead": "You don't have the computing power, the installed software or the time? We take charge of your simulations and deliver the analysed results.",
      "sim.hero.btn": "Request a quote",
      "sim.hero.btn2": "See the services",
      "sim.list.eyebrow": "Our services",
      "sim.list.title": "Six molecular modelling services",
      "sim.list.lead": "Each service can be performed independently or combined into a complete project, from initial screening to article writing.",
      "sim.1.text": "You provide a target and a list of molecules: we prepare the files, define the grid, run the docking and deliver the scores, poses and analysed interactions.",
      "sim.1.li1": "Receptor and ligand preparation (PDBQT)",
      "sim.1.li2": "AutoDock Vina docking, optimised parameters",
      "sim.1.li3": "Validation by redocking and RMSD calculation",
      "sim.1.li4": "PLIP interaction analysis",
      "sim.2.text": "Screening of compound collections (ZINC, PubChem, in-house libraries) with ranking and selection of priority hits.",
      "sim.2.li1": "Library assembly and preparation",
      "sim.2.li2": "Automated, parallelised screening",
      "sim.2.li3": "Clustering of hits by chemical similarity",
      "sim.2.li4": "Final ranking and prioritisation",
      "sim.3.text": "Simulations from 100 ns to several microseconds to assess the stability of your complexes and refine docking predictions.",
      "sim.3.li1": "System preparation (solvation, ions)",
      "sim.3.li2": "Minimisation, equilibration, production",
      "sim.3.li3": "RMSD, RMSF, hydrogen bond analysis",
      "sim.3.li4": "Binding free energy (MM/PBSA, MM/GBSA)",
      "sim.4.text": "Assessment of pharmacokinetic and toxicological properties to eliminate problematic compounds before any laboratory testing.",
      "sim.4.li1": "Absorption, distribution, metabolism, excretion",
      "sim.4.li2": "Lipinski's and Veber's rules",
      "sim.4.li3": "Oral bioavailability prediction",
      "sim.4.li4": "Structural toxicity alerts",
      "sim.5.text": "Obtaining a 3D structure when no experimental structure is available for your target.",
      "sim.5.li1": "AlphaFold2 / ESMFold prediction",
      "sim.5.li2": "Homology modelling (MODELLER)",
      "sim.5.li3": "Quality assessment (pLDDT, PAE, Ramachandran)",
      "sim.5.li4": "Preparing the model for docking",
      "sim.6.text": "Professional formatting of your articles, theses and reports, complying with scientific journal standards.",
      "sim.6.li1": "IMRaD structuring (Introduction, Methods, Results, Discussion)",
      "sim.6.li2": "booktabs tables and siunitx units",
      "sim.6.li3": "Multi-panel figures with subcaption",
      "sim.6.li4": "BibTeX bibliography and journal compliance",
      "sim.quote.eyebrow": "Quote request",
      "sim.quote.title": "Describe your project",
      "sim.quote.lead": "The more precise your description, the more relevant our quote will be. All fields marked with an asterisk are required.",
      "sim.form.contact": "Your contact details",
      "sim.form.name": "Full name",
      "sim.form.email": "Email address",
      "sim.form.org": "Institution or organisation",
      "sim.form.status": "Your status",
      "sim.status.1": "Student",
      "sim.status.2": "PhD student / postdoc",
      "sim.status.3": "Academic researcher",
      "sim.status.4": "Pharmaceutical industry / biotech",
      "sim.status.5": "Other",
      "sim.form.services": "Services requested",
      "sim.form.choose": "Select one or more services",
      "sim.form.details": "Project details",
      "sim.form.target": "Biological target (protein, enzyme, receptor)",
      "sim.form.pdb": "PDB code (if known)",
      "sim.form.count": "Number of molecules to process",
      "sim.count.1": "Fewer than 10",
      "sim.count.2": "10 to 100",
      "sim.count.3": "100 to 1,000",
      "sim.count.4": "1,000 to 100,000",
      "sim.count.5": "More than 100,000",
      "sim.count.6": "I don't know yet",
      "sim.form.deadline": "Desired deadline",
      "sim.delay.1": "Urgent (less than a week)",
      "sim.delay.2": "Two to four weeks",
      "sim.delay.3": "One to three months",
      "sim.delay.4": "No particular constraint",
      "sim.form.desc": "Project description",
      "sim.form.data": "Data already available",
      "sim.form.consent": "I agree that my data may be used to process my quote request. It will not be sold or shared with third parties.",
      "sim.form.submit": "Send my request",
      "sim.form.note": "This form opens your email client. No data is stored on this site.",
      "sim.success.title": "Request prepared",
      "sim.success.text": "Your email client should open with your pre-filled request. We will reply with a tailored quote.",
      "sim.success.ref": "Your reference",
      "sim.success.note": "Keep this reference for any further correspondence.",
      "sim.faq.eyebrow": "Frequently asked questions",
      "sim.faq.title": "What to know before entrusting us with a project",
      "sim.faq.1.q": "How long does a docking take?",
      "sim.faq.1.a": "It depends on the number of molecules and the size of the active site. A few dozen molecules take hours; screening 100,000 compounds requires several days of computation. We specify the deadline in the quote.",
      "sim.faq.2.q": "Do you provide the raw files?",
      "sim.faq.2.a": "Yes. We systematically deliver the raw output files, the scripts used and a methodological report allowing the analysis to be reproduced.",
      "sim.faq.3.q": "Can I publish the results?",
      "sim.faq.3.a": "Yes, the results belong to you. We can be acknowledged or listed as co-authors depending on your level of involvement, to be discussed when quoting.",
      "sim.faq.4.q": "Do you guarantee the activity of the molecules?",
      "sim.faq.4.a": "No. Docking predicts a theoretical affinity, not real biological activity. No computational method replaces experimental testing. We provide hypotheses to be tested, not proof of efficacy.",
      "sim.faq.5.q": "Do you work on confidential data?",
      "sim.faq.5.a": "Yes, on request and after signing a non-disclosure agreement (NDA). We can also work on your own servers if your data cannot leave your institution.",
      "sim.cta.title": "A project to entrust to us?",
      "sim.cta.text": "Describe your needs and we will get back to you with a proposal adapted to your context and budget.",
